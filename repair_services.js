...
if (startIdx !== -1) {
    ...
    const correctHtml = html.substring(0, startIdx + '<script src="/js/cart.js"></script>'.length) + '\n' + perfectScript + '\n' + html.substring(endIdx);
    fs.writeFileSync('e:/Projects/KitchenHood/public/services.html', correctHtml);
    console.log('Successfully repaired services.html');
} else {
    console.log('Could not find cart.js script tag');
}
